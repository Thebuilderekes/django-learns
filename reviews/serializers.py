...
# if i wanted to manually define each field i would do it this way but with ModelSerializer i can do it like below using fields so each attribute reflects the structure of its model
